...
const handler = async (req, res)=>{
    try {
        const { data  } = req.body;
        const { id , address , age , area , group , identitynumber , item , name , phone , wage , cleaner , cleanerWage , headname , headnameWage  } = data;
        await _lib_prismaclient__WEBPACK_IMPORTED_MODULE_0__/* ["default"].contractor.update */ .Z.contractor.update({
            ...
            data: {
                ...
                wage,
                cleaner,
                cleanerWage: Number(cleanerWage),
                headname,
                headnameWage: Number(headnameWage)
            }
        });
