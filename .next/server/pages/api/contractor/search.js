...
const handler = async (req, res)=>{
    try {
        ...
        const menues = await _lib_prismaclient__WEBPACK_IMPORTED_MODULE_0__/* ["default"].categories.findMany */ .Z.categories.findMany({
            where: {
                contractor: {
                    name: {
                        startsWith: search
...
var __webpack_exports__ = (__webpack_exec__(3927));
