...
const handler = async (req, res)=>{
    try {
        const places = await _lib_prismaclient__WEBPACK_IMPORTED_MODULE_0__/* ["default"].places.findMany */ .Z.places.findMany();
...
var __webpack_exports__ = (__webpack_exec__(6589));
