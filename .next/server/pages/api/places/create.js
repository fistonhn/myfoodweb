...
const handler = async (req, res)=>{
    try {
        ...
        await _lib_prismaclient__WEBPACK_IMPORTED_MODULE_0__/* ["default"].places.deleteMany */ .Z.places.deleteMany();
        await Promise.all(places.map(async (p)=>{
            await _lib_prismaclient__WEBPACK_IMPORTED_MODULE_0__/* ["default"].places.create */ .Z.places.create({
                data: {
                    name: p.name,
...
var __webpack_exports__ = (__webpack_exec__(7593));
