...
const handler = async (req, res)=>{
    try {
        ...
        const isExists = await _lib_prismaclient__WEBPACK_IMPORTED_MODULE_0__/* ["default"].user.findUnique */ .Z.user.findUnique({
            where: {
                id: id
            }
        });
        ...
        await _lib_prismaclient__WEBPACK_IMPORTED_MODULE_0__/* ["default"].user.update */ .Z.user.update({
            where: {
                id: id
            },
            data: {
